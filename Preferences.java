...
public final class Preferences {
	...
	// Sizing:
	public static final int NUM_CELL_ADJUST = 50;
	...
	public static final Font TITLE_FONT = new Font("AR DESTINE", Font.PLAIN, 50);	
	public static final Color TITLE_COLOR = Color.BLUE;
	public static final String TITLE = "SNAKE"; // 
	// Text display - Game Over
	public static final int GAME_OVER_X = 200;
